      ...
      <div className="footer-wave-container">
        <svg className="footer-wave-svg wave-layer-1" viewBox="0 0 1440 160" preserveAspectRatio="none">
          <g transform="translate(0, 0)">
            <path d="M0 80 C 120 120, 240 120, 360 80 C 480 40, 600 40, 720 80 C 840 120, 960 120, 1080 80 C 1200 40, 1320 40, 1440 80 C 1560 120, 1680 120, 1800 80 C 1920 40, 2040 40, 2160 80 C 2280 120, 2400 120, 2520 80 C 2640 40, 2760 40, 2880 80 L 2880 160 L 0 160 Z" fill="rgba(47, 89, 67, 0.15)" />
          </g>
        </svg>
        <svg className="footer-wave-svg wave-layer-2" viewBox="0 0 1440 160" preserveAspectRatio="none">
          <g transform="translate(-180, 4)">
            <path d="M0 80 C 120 120, 240 120, 360 80 C 480 40, 600 40, 720 80 C 840 120, 960 120, 1080 80 C 1200 40, 1320 40, 1440 80 C 1560 120, 1680 120, 1800 80 C 1920 40, 2040 40, 2160 80 C 2280 120, 2400 120, 2520 80 C 2640 40, 2760 40, 2880 80 L 2880 160 L 0 160 Z" fill="rgba(47, 89, 67, 0.35)" />
          </g>
        </svg>
        <svg className="footer-wave-svg wave-layer-3" viewBox="0 0 1440 160" preserveAspectRatio="none">
          <g transform="translate(-360, 8)">
            <path d="M0 80 C 120 120, 240 120, 360 80 C 480 40, 600 40, 720 80 C 840 120, 960 120, 1080 80 C 1200 40, 1320 40, 1440 80 C 1560 120, 1680 120, 1800 80 C 1920 40, 2040 40, 2160 80 C 2280 120, 2400 120, 2520 80 C 2640 40, 2760 40, 2880 80 L 2880 160 L 0 160 Z" fill="rgba(47, 89, 67, 0.55)" />
          </g>
        </svg>
        <svg className="footer-wave-svg wave-layer-4" viewBox="0 0 1440 160" preserveAspectRatio="none">
          <g transform="translate(-540, 12)">
            <path d="M0 80 C 120 120, 240 120, 360 80 C 480 40, 600 40, 720 80 C 840 120, 960 120, 1080 80 C 1200 40, 1320 40, 1440 80 C 1560 120, 1680 120, 1800 80 C 1920 40, 2040 40, 2160 80 C 2280 120, 2400 120, 2520 80 C 2640 40, 2760 40, 2880 80 L 2880 160 L 0 160 Z" fill="#2F5943" />
          </g>
        </svg>
      </div>
